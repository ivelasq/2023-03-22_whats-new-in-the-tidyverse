...
The tidyverse team uses [vctrs](https://vctrs.r-lib.org/) to keep recycling rules and coercion rules in one place.

This doesn't impact data scientists too much but it means more consistency and better error messages, bug fixes, and higher quality code.
